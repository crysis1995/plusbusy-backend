    ...
    validate() {
        ...
        switch (true) {
            ...
            case this.value.Name !== undefined:
                validators.push(
                    GeneralDriverValidator.validateNameMaxLength(
                        this.value.Name
                    )
                );
                validators.push(
                    GeneralDriverValidator.validateNameMinLength(
                        this.value.Name
                    )
                );
            ...
            case this.value.Surname !== undefined:
                validators.push(
                    GeneralDriverValidator.validateSurnameMaxLength(
                        this.value.Surname
                    )
                );
                validators.push(
                    GeneralDriverValidator.validateSurnameMinLength(
                        this.value.Surname
                    )
                );
