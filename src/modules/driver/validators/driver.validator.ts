...
export class DriverValidator extends Validator<Driver | CreateDriverDto | UpdateDriverDto> {
    validate() {
        if (this.value instanceof Driver) return new DriverStrategyValidator(this.value).validate();
